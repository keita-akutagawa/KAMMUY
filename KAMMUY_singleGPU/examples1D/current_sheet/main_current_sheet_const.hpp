...
std::string directoryname = "/cfca-work/akutagawakt/KAMMUY/1D/results_current_sheet";
std::string filenameWithoutStep = "current_sheet";
std::ofstream logfile("/cfca-work/akutagawakt/KAMMUY/1D/results_current_sheet/log_current_sheet.txt");
...
const int PIC2DConst::nx_PIC = 10;
...
const int IdealMHD2DConst::ny_MHD = 2000;
...
const unsigned long long Interface2DConst::reloadParticlesTotalNumIon = sqrt(betaUpstream) * PIC2DConst::numberDensityIon_PIC * PIC2DConst::nx_PIC * PIC2DConst::ny_PIC;
const unsigned long long Interface2DConst::reloadParticlesTotalNumElectron = sqrt(betaUpstream) * PIC2DConst::numberDensityElectron_PIC * PIC2DConst::nx_PIC * PIC2DConst::ny_PIC;
...
const int PIC2DConst::numberDensityIon_PIC = 40;
const int PIC2DConst::numberDensityElectron_PIC = 40;
...
const unsigned long long backgroundNumIon_PIC = round(sqrt(betaUpstream) * nx_PIC * ny_PIC * numberDensityIon_PIC);
const unsigned long long harrisNumElectron_PIC = round(nx_PIC * numberDensityElectron_PIC * 2.0 * sheatThickness);
const unsigned long long backgroundNumElectron_PIC = round(sqrt(betaUpstream) * nx_PIC * ny_PIC * numberDensityElectron_PIC);
...
const unsigned long long PIC2DConst::totalNumIon_PIC = existNumIon_PIC + Interface2DConst::reloadParticlesTotalNumIon * 2;
const unsigned long long PIC2DConst::totalNumElectron_PIC = existNumElectron_PIC + Interface2DConst::reloadParticlesTotalNumElectron * 2;
...
const double vThIonB_PIC = sqrt(2.0 * tIon_PIC * sqrt(betaUpstream) / mIon_PIC);
const double vThElectronB_PIC = sqrt(2.0 * tElectron_PIC * sqrt(betaUpstream) / mElectron_PIC);
