...
std::string directoryname = "/cfca-work/akutagawakt/KAMMUY/results_alfven";
std::string filenameWithoutStep = "alfven";
std::ofstream logfile("/cfca-work/akutagawakt/KAMMUY/results_alfven/log_alfven.txt");

const int IdealMHD2DConst::totalStep_MHD = 50000;
