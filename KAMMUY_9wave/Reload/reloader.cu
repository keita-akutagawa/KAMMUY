...
)
{
    ...
    ifsParticleNumIon.read(reinterpret_cast<char*>(&PIC2DConst::existNumIon), sizeof(unsigned long long));
    ifsParticleNumElectron.read(reinterpret_cast<char*>(&PIC2DConst::existNumElectron), sizeof(unsigned long long));
