...
std::string directoryName = "/cfca-work/akutagawakt/KAMMUY_9wave/results_takasao2015_beta0.1_harris";
std::string filenameWithoutStep = "takasao2015_beta0.1_harris";
std::ofstream logfile(    directoryName + "/log_takasao2015_beta0.1_harris.txt"       );
std::ofstream mpifile_MHD(directoryName + "/mpilog_mhd_takasao2015_beta0.1_harris.txt");
...
unsigned long long PIC2DConst::existNumIon = round(PIC2DConst::nx * PIC2DConst::numberDensityIon * 2.0 * sheatThickness + PIC2DConst::nx * PIC2DConst::ny * 1.0 * PIC2DConst::numberDensityIon);
...
double IdealMHD2DConst::cr = 10.0; 
