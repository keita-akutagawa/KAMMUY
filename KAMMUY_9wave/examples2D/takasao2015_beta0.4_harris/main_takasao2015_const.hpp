...
std::string directoryName = "/cfca-work/akutagawakt/KAMMUY_9wave/results_takasao2015_beta0.4_harris";
std::string filenameWithoutStep = "takasao2015_beta0.4_harris";
std::ofstream logfile(    directoryName + "/log_takasao2015_beta0.4_harris.txt"       );
std::ofstream mpifile_MHD(directoryName + "/mpilog_mhd_takasao2015_beta0.4_harris.txt");
