...
std::string directoryName = "/cfca-work/akutagawakt/KAMMUY_9wave/results_mrx_beta0.1_harris";
std::string filenameWithoutStep = "mrx_beta0.1_harris";
std::ofstream logfile(    directoryName + "/log_mrx_beta0.1_harris.txt"       );
std::ofstream mpifile_MHD(directoryName + "/mpilog_mhd_mrx_beta0.1_harris.txt");
...
const int IdealMHD2DConst::ny = 500 / Interface2DConst::gridSizeRatio;
