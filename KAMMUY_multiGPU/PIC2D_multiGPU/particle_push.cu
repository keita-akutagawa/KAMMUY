...
)
{
    ...
    yOverDy = (particle.y - yminForProcs + buffer * PIC2DConst::device_dy) / PIC2DConst::device_dy;
...
)
{
    ...
    if (i < existNumSpecies) {
        ...
        float boundaryDeleteLeft  = xminForProcs - buffer * PIC2DConst::device_dx + PIC2DConst::device_EPS; 
        float boundaryDeleteRight = xmaxForProcs + buffer * PIC2DConst::device_dx - PIC2DConst::device_EPS; 
        ...
        float boundaryMPISendLeft  = xminForProcs + buffer * PIC2DConst::device_dx; 
        float boundaryMPISendRight = xmaxForProcs - buffer * PIC2DConst::device_dx; 
        float boundaryMPISendDown  = yminForProcs + buffer * PIC2DConst::device_dy; 
        float boundaryMPISendUp    = ymaxForProcs - buffer * PIC2DConst::device_dy; 
