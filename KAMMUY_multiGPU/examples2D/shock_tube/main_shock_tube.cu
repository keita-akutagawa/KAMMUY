...
__global__ void initializePICField_kernel(
    ...
    double uLeft, double vLeft, double wLeft, 
    double bXLeft, double bYLeft, double bZLeft, 
    double uRight, double vRight, double wRight, 
    double bXRight, double bYRight, double bZRight, 
