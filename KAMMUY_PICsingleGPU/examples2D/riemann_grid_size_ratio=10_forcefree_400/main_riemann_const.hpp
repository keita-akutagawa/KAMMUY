...
std::string directoryName = "/cfca-work/akutagawakt/paper4_PICsingleGPU/results_riemann_grid_size_ratio=10_forcefree_400";
std::string filenameWithoutStep = "riemann";
std::ofstream logfile(    directoryName + "/log_riemann.txt"       );
std::ofstream mpifile_MHD(directoryName + "/mpilog_mhd_riemann.txt");


const int bufferMHD = 3; 

const std::string IdealMHD2DConst::MTXfilename = "/home/akutagawakt/paper4_PICsingleGPU/examples2D/riemann_grid_size_ratio=10_forcefree_400/poisson_symmetric.mtx";
const std::string IdealMHD2DConst::jsonFilenameForSolver = "/home/akutagawakt/paper4_PICsingleGPU/examples2D/riemann_grid_size_ratio=10_forcefree_400/PCG_W.json";
...
const double PIC2DConst::EPS = 1e-10;
