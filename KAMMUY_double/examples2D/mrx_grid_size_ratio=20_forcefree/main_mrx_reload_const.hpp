...
std::ofstream mpifile_PIC(directoryName + "/mpilog_pic_mrx_reload.txt");
std::ofstream mpifile_Interface(directoryName + "/mpilog_interface_mrx_reload.txt");


const int reloadStep = 1405;
