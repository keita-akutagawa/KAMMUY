...
void PIC2DMPI::setupInfo(MPIInfo& mPIInfo, int buffer, int mpiBufNumParticles)
{
    ...
    MPI_Datatype types_zerothMoment[1] = {MPI_DOUBLE};
    ...
    MPI_Datatype types_firstMoment[3] = {MPI_DOUBLE, MPI_DOUBLE, MPI_DOUBLE};
    ...
    MPI_Datatype types_secondMoment[6] = {MPI_DOUBLE, MPI_DOUBLE, MPI_DOUBLE, MPI_DOUBLE, MPI_DOUBLE, MPI_DOUBLE};
