...
const double PIC2DConst::xmin_PIC = 0.5 * dx_PIC; 
const double PIC2DConst::xmax_PIC = nx_PIC * dx_PIC - 1.5 * dx_PIC;
...
const double IdealMHD2DConst::xmin_MHD = 0.5 * dx_MHD;
const double IdealMHD2DConst::xmax_MHD = nx_MHD * dx_MHD - 1.5 * dx_MHD;
