...
std::string directoryname = "/cfca-work/akutagawakt/KAMMUY/2D/results_current_sheet_press";
std::string filenameWithoutStep = "current_sheet";
std::ofstream logfile("/cfca-work/akutagawakt/KAMMUY/2D/results_current_sheet_press/log_current_sheet.txt");
