...
const float PIC2DConst::ymin = 0.0f; 
const float PIC2DConst::ymax = PIC2DConst::ny * PIC2DConst::dy;
...
const int IdealMHD2DConst::ny = 250;
...
const int indexOfConvolutionStartInPIC_lowerInterface = -1; //使わない
const int indexOfConvolutionStartInMHD_lowerInterface = IdealMHD2DConst::ny + 2 * buffer - convolutionSizeY; 
const int indexOfConvolutionStartInPIC_upperInterface = -1; //使わない
