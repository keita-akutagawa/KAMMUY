...
)
{
    ...
    thrust::device_vector<ReloadParticlesData> sendDataLeft(mPIInfo.buffer * localNy), sendDataRight(mPIInfo.buffer * localNy);
    thrust::device_vector<ReloadParticlesData> recvDataLeft(mPIInfo.buffer * localNy), recvDataRight(mPIInfo.buffer * localNy);
