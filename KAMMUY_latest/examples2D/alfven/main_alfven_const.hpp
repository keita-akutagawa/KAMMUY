...
const int IdealMHD2DConst::ny = 2470;
...
const int indexOfInterfaceStartInMHD_lower = IdealMHD2DConst::ny - Interface2DConst::interfaceLength;
const int indexOfInterfaceStartInPIC_upper = PIC2DConst::ny - Interface2DConst::interfaceLength;
const int indexOfInterfaceStartInMHD_upper = 0;

const int convolutionSizeXMHD = IdealMHD2DConst::nx + 2 * buffer; 
const int convolutionSizeYMHD = Interface2DConst::interfaceLength * 2; 
const int convolutionSizeXPIC = PIC2DConst::nx + 2 * buffer; 
const int convolutionSizeYPIC = Interface2DConst::interfaceLength * 2; 
const int indexOfConvolutionStartInPIC_lowerInterface = 0;
const int indexOfConvolutionStartInMHD_lowerInterface = IdealMHD2DConst::ny - convolutionSizeYMHD; 
const int indexOfConvolutionStartInPIC_upperInterface = PIC2DConst::ny - convolutionSizeYPIC;
