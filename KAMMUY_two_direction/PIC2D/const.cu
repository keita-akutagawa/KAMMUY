...
void PIC2DConst::initializeDeviceConstants()
{
    ...
    cudaMemcpyToSymbol(device_dOfLangdonMarderTypeCorrection, &dOfLangdonMarderTypeCorrection, sizeof(double));
    ...
    cudaMemcpyToSymbol(device_ionInertialLength, &ionInertialLength, sizeof(double));
